...
export default function Home() {
  ...
  if (!config) return <div className="flex items-center justify-center min-h-screen bg-[var(--secondary)] text-[var(--text-gray)]">Loading...</div>;
    ...
    <div className="min-h-screen">
      ...
      <main ref={timelineRef} className="relative overflow-hidden">
            ...
            {config.timelineEvents.map((event, index) => (
              ...
              >
                ...
                >
                  ...
                  <h3 className="text-xl text-[var(--text-gray)]/70 mt-2">{event.subtitle}</h3>
                  <p className="text-md text-[var(--text-gray)]/50 mt-1">{event.location}</p>
                </motion.div>
        ...
        <div
          ...
          onClick={scrollUp}
        >
          <svg className="w-12 h-12 text-[var(--topcoat-white)] bg-[var(--primary)] bg-opacity-40 rounded-full p-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
